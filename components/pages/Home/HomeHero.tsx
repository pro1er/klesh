  ...
  return (
    <div className="w-full h-screen">
      <div className="absolute p-9 flex items-center justify-between w-full">
        <Image src="/l4.png" width={140} height={140} alt=""/>
      ...
      <div className="w-full h-full flex items-center">
        ...
        <div className="absolute flex flex-col  ml-44 gap-8">
          <h1 className="2xl:text-[100px] xl:text-[80px] text-big font-monBlack leading-[1.2]">
            Household <br /> Cleaning <br /> Products
          </h1>
          <p className="2xl:text-[20px] xl:text-[16px] text-small font-monRegular ">
